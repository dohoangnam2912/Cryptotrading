...
def get_dataset(RUN):
    ...
    """
    #/home/yosakoi/Work/Jupyternote/22953377(1)/CryptoTrading/processed_data/raw_data_4_hour_train_test_data.csv
    # ds = pd.read_csv("./processed_data/%strain_test_data.csv" % RUN['folder'].replace('/', '_'))
    ds = pd.read_csv("/home/yosakoi/Work/Jupyternote/22953377(1)/CryptoTrading/processed_data/raw_data_4_hour_train_test_data.csv")
